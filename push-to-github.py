...
if push_result.returncode == 0:
    ...
    # Remote has commits local doesn't — pull first, resolve conflicts if needed
    ...
    if pull.returncode != 0 and b"CONFLICT" in pull.stderr:
        ...
        # Resolve data file by keeping HEAD (remote full history)
        ...
        subprocess.run(["git", "commit", "-m", "Merge: keep local pipeline scripts"], capture_output=True)
